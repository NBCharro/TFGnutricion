    ...
    <section>
        @error('email')
            <div class="flex p-4 mb-4 text-sm text-red-800 border border-red-300 rounded-lg bg-red-50 dark:bg-gray-800 dark:text-red-400 dark:border-red-800 md:mx-4"
                ...
                <div>
                    <span class="font-bold">Oh no! Algo ha salido mal.</span> Verifica que has introducido correctamente tu
                    correo electrónico y contraseña e intenta de nuevo. Si el problema persiste, ponte en contacto con nuestro
                    equipo de soporte.
                </div>
            </div>
        @enderror
