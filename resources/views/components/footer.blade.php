<footer
    ...
    <div class="flex justify-center items-center space-x-1">
        <a href="#" data-tooltip-target="tooltip-facebook"
            class="inline-flex justify-center p-2 text-gray-500 dark:text-tertiary-100 cursor-pointer dark:bg-tertiary-700 dark:hover:text-primary-50 hover:text-gray-900 hover:bg-gray-100">
