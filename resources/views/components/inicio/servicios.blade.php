<section id="servicios"
    class="bg-white dark:bg-tertiary-700 bg-[url('/public/images/dotGrid.png')] bg-center bg-repeat bg-fixed">
    <div class="mx-auto max-w-screen-md text-center mb-8 lg:mb-12 pt-12">
        <h2 class="mb-4 text-4xl tracking-tight font-extrabold dark:text-white">Servicios</h2>
    </div>
    <div class="container m-auto px-6 py-12 text-white md:px-12 xl:px-0">
        <div class="mx-auto grid gap-6 md:w-3/4 lg:w-full lg:grid-cols-4">
            <div
                ...
                <div class="absolute inset-0 bg-tertiary-700/40 rounded-2xl"></div>
