<section class="bg-white dark:bg-tertiary-700 bg-[url('/public/images/dotGrid.png')] bg-center bg-repeat bg-fixed">
    <div class="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6">
        <div class="mx-auto max-w-screen-md text-center mb-8 lg:mb-12">
            <h2 class="mb-4 text-4xl tracking-tight font-extrabold text-gray-900 dark:text-white">Precios</h2>
        </div>
        <div class="space-y-8 lg:grid lg:grid-cols-3 sm:gap-6 xl:gap-10 lg:space-y-0">
            ...
            <div
                ...
                dark:border-gray-600 xl:p-8 dark:bg-gray-900 ring ring-transparent hover:ring-tertiary-100 dark:ring-tertiary-100 dark:hover:ring-primary-50">
                ...
                <ul role="list" class="mb-8 space-y-4 text-left">
                    ...
                    <li class="flex items-center space-x-3">
                        ...
                        <span>3 meses de seguimiento</span>
                    </li>
                    <li class="flex items-center space-x-3">
                        <!-- Icon -->
                        <svg class="flex-shrink-0 w-5 h-5 text-white dark:text-tertiary-100" fill="currentColor"
                        ...
                        <span>Revisión de la dieta</span>
                    </li>
                    <li class="flex items-center space-x-3">
                        <!-- Icon -->
                        <svg class="flex-shrink-0 w-5 h-5 text-white dark:text-tertiary-100" fill="currentColor"
