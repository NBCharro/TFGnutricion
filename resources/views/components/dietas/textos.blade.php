...
<div id="textos"
    ...
    <div id="texto_general" class="hidden md:grid-cols-5 md:gap-4">
        ...
        <input type="text" name="texto_general_titulo"
            class="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:text-white col-span-4 my-2"
            {{-- value="Dieta de 1350 Kcal aprox."> --}}
            value="{{ isset($textos_cliente_seleccionado['titulo']) ? $textos_cliente_seleccionado['titulo'] : 'Dieta de 1350 Kcal aprox.' }}">
