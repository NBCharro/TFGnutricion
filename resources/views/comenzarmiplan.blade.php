                ...
                <div class="grid grid-cols-2 gap-3">
                    @php
                        ...
                        foreach ($preguntas_respuestas_clientes as $pregunta => $respuesta) {
                            ...
                            echo "<label for='pregunta_respuesta_$index' class='block mb-1 text-sm font-medium text-right'>";
                            echo "$pregunta";
                            echo '</label>';
                            echo "<input type='text' id='pregunta_respuesta_$index' class='bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white' placeholder='Responda aqui' required value='$respuesta_anterior'>";
                            $index++;
                        }
                    @endphp
                </div>
